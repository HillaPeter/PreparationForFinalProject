...
public class Owner extends Member {
    ...
    public Owner(String name, String userMail, String password,DBController dbController) {
        super(name, userMail, password);
        this.dbController=dbController;
        teams=new HashMap<>();
        for(String teamName:dbController.getTeams().keySet()){
     ...
     */
    public void addManager(String teamName, String mailId) throws MemberNotExist, AlreadyExistException {
     ...
     * @param teamName,mailId
     */
    public void addCoach(String teamName, String mailId) throws MemberNotExist, AlreadyExistException {
        Team team =  teams.get(teamName);
     ...
     * @param teamName,mailId
     */
    public void addPlayer(String teamName, String mailId,int year, int month, int day, String roleInPlayers) throws MemberNotExist, AlreadyExistException {
        Team team =  teams.get(teamName);
    ...
    public void addField(String teamName,  String fieldName) {
        ...
        dbController.getTeams().get(teamName).setTrainingFields(trainingFields);
    }
     ...
     * @param mailInput
     */
    public void removeManager(String teamName, String mailInput) throws MemberNotExist, AlreadyExistException {
        //gets the team
        Team team = teams.get(teamName);
     ...
     * @param mailInput
     */
    public void removeCoach(String teamName, String mailInput) throws MemberNotExist, AlreadyExistException {
        //gets the team
        Team team = dbController.getTeams().get(teamName);
        //gets the list of managers
     ...
     * @param mailInput
     */
    public void removePlayer(String teamName, String mailInput) throws MemberNotExist, AlreadyExistException {
        //gets the team
        Team team = dbController.getTeams().get(teamName);
        //gets the list of managers
     ...
     * @param fieldName
     */
    public void removeField(String teamName, String fieldName) {
        Team team = dbController.getTeams().get(teamName);
     ...
     * @param mailId
     */
    public void addNewOwner(String teamName, String mailId) throws MemberNotExist, AlreadyExistException {
        Team team = teams.get(teamName);
     ...
     * @param teamName
     */
    public void temporaryTeamClosing(String teamName) {
        Team team = dbController.getTeams().get(teamName);
     ...
     * @param teamName
     */
    public void reopenClosedTeam(String teamName) { ;
        Team team = dbController.getTeams().get(teamName);
        team.setStatus(true);
        dbController.getTeams().replace(teamName,team);
    }
     ...
     * @param amount
     */
    public void addOutCome(String teamName, String description, double amount) throws NoEnoughMoney {
        Team team = dbController.getTeams().get(teamName);
     ...
     * @param amount
     */
    public void addInCome(String teamName, String description, double amount) {
        Team team = dbController.getTeams().get(teamName);
        team.addTransaction(description, amount);
        team.getAccount().setAmountOfTeam(team.getAccount().getAmountOfTeam() + amount);
        dbController.getTeams().replace(teamName,team);
